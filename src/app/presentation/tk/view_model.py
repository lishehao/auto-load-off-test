...
class ViewModel:
    def __init__(self, root: tk.Misc) -> None:
        ...
        self.elapsed_text = tk.StringVar(root, value="00:00")
        self.latest_frequency_text = tk.StringVar(root, value="-")
        self.point_count_text = tk.StringVar(root, value="0 points")
        self.data_source_text = tk.StringVar(root, value="Live instrument path")
        self.fixture_badge_text = tk.StringVar(root, value="")
        self.validation_receipt_text = tk.StringVar(root, value="Live run requires operator hardware checks")
        self.reference_receipt_text = tk.StringVar(root, value="No reference loaded")
        self.export_receipt_text = tk.StringVar(root, value="No export yet")
        self.event_history_text = tk.StringVar(root, value="No warnings or workflow events")
